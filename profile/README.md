...
This profile contains **real-world tooling and payload lists** used for recon, fuzzing and web exploitation.

No theory. No noise. Practical stuff only.
...
### ⚙️ PSFuzz
Proviesec Fuzz Scanner – fast dir/path web scanner written in Go.
...
Curated directory & file payload lists for scanners and fuzzers.
...
### 💥 xss-payload-list
Practical XSS payloads for different contexts and filters.
...
⭐ If something helps you — star the repo.
